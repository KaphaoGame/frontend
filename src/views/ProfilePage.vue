<template>
  <div class="container">
    ...
    <div v-if="editStatus === false">
      ...
      >
        <b-card-text>
          <h3>Real Name: {{ getFirstName }} {{ getLastName }}</h3>
          <br />
          ...
          <br />
            ...
            <!-- <div v-if="deleteStatus === false">
              <b-button @click="editPro" variant="warning"
                >Edit Profile</b-button
              >
              <b-button @click="deletePro" variant="danger">
                Delete Profile
              </b-button>
            </div>
            <div v-else>
              <b-button @click="onDeleteCancel">Cancel</b-button>
              <b-button @click="onDeleteSubmit" variant="danger"
                >Confirm</b-button
              >
            </div> -->
      ...
      <!-- <div class="form-group-2">
        <div class="realName">
          Real Name: {{ getFirstName }} {{ getLastName }}
        </div>
        <br />
    ...
    <div v-else align="center" id="edit-card">
      ...
      <br />
      <input v-model="user.firstName" :placeholder="user.firstName" />
      <br />
      <span class="form-group-2"> Lastname </span>
      <br />
      <input v-model="user.lastName" :placeholder="user.lastName" />
      <br />
      ...
      <br />
      <input v-model.number="user.email" :placeholder="user.email" />
      <br />
      <br />
      <div>
